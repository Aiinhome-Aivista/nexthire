          ...
          <div class="sidebar" id="sidebar">
                    ...
                    <nav class="sidebar-menu">
                              <ul>
                                        ...
                                        <li><a href="<?= base_url('admin/featured_companies') ?>" class="active"><i class="fas fa-building"></i> <span>Featured Companies</span></a></li>
                                        <li>
                                                  <a href="#" id="logoutBtn">
                                        ...
                                        <table>
                                                  ...
                                                  <tbody id="featuredcompaniesTableBody">
                                                            <?php if (!empty($featured_companies)): ?>
                                                                      <?php foreach ($featured_companies as $featured_companies): ?>
                                                                                <tr data-id="<?= $featured_companies->id ?>" data-is-featured="<?= htmlspecialchars($featured_companies->is_featured) ?>">
                                                                                          <td data-label="ID" class="col-id"><?= htmlspecialchars($featured_companies->id) ?></td>
                                                                                          <td data-label="Company Name" class="col-company-name"><?= htmlspecialchars($featured_companies->company_name) ?></td>
                                                                                          <!-- <td data-label="Image" class="col-logo"><?= htmlspecialchars($featured_companies->logo) ?></td> -->
                                                                                          <td data-label="Image" class="col-logo">
                                                                                                    <img src="<?= base_url(htmlspecialchars($featured_companies->logo)) ?>" alt="Company Logo" style="max-width: 100px; max-height: 50px;">
                                                                                          </td>
                                                                                          <td data-label="Ratings" class="col-rating"><?= htmlspecialchars($featured_companies->rating) ?></td>
                                                                                          <td data-label="Reviews" class="col-reviews"><?= htmlspecialchars($featured_companies->reviews) ?></td>
                                                                                          <td data-label="Description" class="col-description"><?= htmlspecialchars($featured_companies->description) ?></td>
                                                            ...
                                                            <?php else: ?>
                                                                      <tr class="table-no-jobposts">
                                                                                <td colspan="11">No Featured Companies Found</td>
                                                                      </tr>
                                                            <?php endif; ?>
                                                  </tbody>
                                        </table>
                    ...
                    <div class="modal-content">
                              ...
                              <div class="modal-body scrollable">
                                        <form id="editForm">
                                                  ...
                                                  <div class="form-group"><label>Company Name</label><input type="text" id="edit_company_name" class="form-control"></div>
                                                  <!-- <div class="form-group"><label>Image</label><input type="text" id="edit_logo" class="form-control"></div> -->
                                                  <div class="form-group">
                                                            <label>Current Image</label>
                                                            <div id="currentImageContainer">
                                                                      <img id="currentImagePreview" src="" style="max-width: 100px; max-height: 50px; display: none;">
                                                            </div>
                                                  </div>
                                                  <div class="form-group">
                                                  ...
                                                  <div class="form-group"><label>Ratings</label><input type="text" id="edit_rating" class="form-control"></div>
                                                  <div class="form-group"><label>Reviews</label><input type="text" id="edit_reviews" class="form-control"></div>
                                                  <div class="form-group"><label>Description</label><textarea id="edit_description" class="form-control"></textarea></div>
                                                  <div class="form-group">
          ...
          <script>
                    ...
                    document.addEventListener('click', e => {
                              if (e.target.closest('.btn-edit')) {
                                        ...
                                        document.getElementById('edit_company_name').value = row.querySelector('.col-company-name').textContent;
                                        ...
                                        document.getElementById('edit_rating').value = row.querySelector('.col-rating').textContent;
                                        document.getElementById('edit_reviews').value = row.querySelector('.col-reviews').textContent;
                                        document.getElementById('edit_description').value = row.querySelector('.col-description').textContent;
